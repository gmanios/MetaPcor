...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      textInput(inputId = 'GEO_names', 'Enter a vector of GSEs (comma delimited)', ""),
      ...
      selectInput(inputId = "option",
                  ...
                  choices = c("Pearson correlation and partial correlation meta-analysis", "Partial correlation meta-analysis with thresholds", "Partial correlation meta-analysis","Meta-anaysis and partial correlation meta-analysis","DE and partial correlation meta-analysis")),
      ...
      numericInput(inputId = "l1",
                   label = "l1 (Only if you choose sparse as a method):",
                   value = 0.8),
      
      
      # Input: Numeric entry for number of obs to view ----
      numericInput(inputId = "l2",
                   label = "l2 (Only if you choose sparse as a method):",
                   value = 0),
